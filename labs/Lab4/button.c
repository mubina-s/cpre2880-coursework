...
void button_init() {
  ...
  // while ((SYSCTL_PRGPIO_R & 0x??) == 0) {};
	...
	SYSCTL_RCGCGPIO_R |= 0X10; // enables the clock for port e
...
//GPIO_DATA 0x000000F means nothing pressed. 0x000000E is button 1. 0x000000D is button 2. 0x000000B is button 3. 0x0000007 is button 4
